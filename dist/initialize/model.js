...
exports.default = (function (name) { return ({
    ...
    reducers: {
        initialProgress: function (state, payload) {
            return __assign({}, state, { progress: payload });
        },
        initialComplete: function (state, payload) {
            return __assign({}, state, { pending: false });
        }
    },
    effects: function (dispatch) { return ({
        initialProgressAsync: function (payload, rootState, times) {
            if (times === void 0) { times = 300; }
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, new Promise(function (resolve) { return setTimeout(resolve, times); })];
                        case 1:
                            _a.sent();
        ...
        initialCompleteAsync: function (payload, rootState, times) {
